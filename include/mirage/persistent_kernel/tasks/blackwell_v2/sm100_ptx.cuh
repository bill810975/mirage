...
// future kernels).
#pragma once
// Include guard shared with the byte-identical twin of this header
// (tasks/blackwell/sm100_ptx.cuh <-> tasks/blackwell_v2/sm100_ptx.cuh):
// a v2-enabled megakernel TU includes both paths, and the twin copies
// define the same kernel::sm100_ptx:: functions. The shared guard makes
// the second include a no-op. Keep BOTH copies byte-identical.
