...
inline ::mirage::runtime::TaskSmemInfo make_p0_qkva_smem_info(int nwarps) {
  ...
  ::mirage::runtime::TaskSmemInfo info{work_bytes + ring_bytes,
                                       /*alignment=*/1024,
                                       {}};
  info.regions.push_back({"attn_p0_work",
                          work_bytes,
                          1024,
                          /*page_count=*/2,
                          /*can_pack=*/false,
                          /*release_step=*/2,
                          /*contiguous=*/true});
  info.regions.push_back({"attn_p0_ring",
                          ring_bytes,
                          1024,
                          /*page_count=*/ring_pages,
                          /*can_pack=*/false,
                          /*release_step=*/2,
                          /*contiguous=*/true});
  return info;
...
inline ::mirage::runtime::TaskSmemInfo make_qb_rope_kv_smem_info(int nwarps) {
  ...
  ::mirage::runtime::TaskSmemInfo info{work_bytes + ring_bytes,
                                       /*alignment=*/1024,
                                       {}};
  info.regions.push_back({"attn_qb_work",
                          work_bytes,
                          1024,
                          /*page_count=*/1,
                          /*can_pack=*/false,
                          /*release_step=*/2,
                          /*contiguous=*/true});
  info.regions.push_back({"attn_qb_ring",
                          ring_bytes,
                          1024,
                          /*page_count=*/ring_pages,
                          /*can_pack=*/false,
...
inline ::mirage::runtime::TaskSmemInfo make_mla_partial_smem_info() {
  ...
  info.regions.push_back({"attn_mp_work",
                          work_bytes,
                          1024,
                          /*page_count=*/1,
                          /*can_pack=*/true,
...
inline ::mirage::runtime::TaskSmemInfo make_mla_merge_smem_info() {
  ...
  ::mirage::runtime::TaskSmemInfo info{work_bytes, /*alignment=*/1024, {}};
  info.regions.push_back({"attn_mm_work",
                          work_bytes,
                          1024,
                          /*page_count=*/1,
                          /*can_pack=*/true,
...
inline ::mirage::runtime::TaskSmemInfo make_oproj_smem_info(int nwarps) {
  ...
  ::mirage::runtime::TaskSmemInfo info{work_bytes + ring_bytes,
                                       /*alignment=*/1024,
                                       {}};
  info.regions.push_back({"attn_op_work",
                          work_bytes,
                          1024,
                          /*page_count=*/1,
                          /*can_pack=*/false,
                          /*release_step=*/2,
                          /*contiguous=*/true});
  info.regions.push_back({"attn_op_ring",
                          ring_bytes,
                          1024,
                          /*page_count=*/ring_pages,
                          /*can_pack=*/false,
