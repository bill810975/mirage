// MLA Multi-Token Decode for DeepSeek V3 on B200 (SM100a) — TP=4 (32 heads)
//
// Adapted from ferret/examples/mla-mtp-decode-q1to8-kv4096/v007_tp4_swapab.cu
...
// ============ Reduction Kernel ============
__device__ __noinline__ void
    mla_mtp_tp4_reduce(nv_bfloat16 const *__restrict__ Oa,
