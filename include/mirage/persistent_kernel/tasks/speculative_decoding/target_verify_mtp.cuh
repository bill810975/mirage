...
__device__ __forceinline__ void target_verify_strict_kernel(
  ...
  int *__restrict__ accepted_count =
      static_cast<int *>(accepted_count_ptr);
...
__device__ __forceinline__ void target_verify_synthetic_kernel(
  ...
  float const *__restrict__ decay =
      static_cast<float const *>(decay_ptr);
  unsigned long long const *__restrict__ seed =
      static_cast<unsigned long long const *>(seed_ptr);
  int *__restrict__ accepted_count =
      static_cast<int *>(accepted_count_ptr);
...
template <int NUM_DRAFT_TOKENS>
__device__ __forceinline__ void mtp_accept_commit_kernel(
