...
#if MPK_TARGET_CC >= 100
// B200: 228KB total, need 225KB dynamic for FP8 CUTLASS (224KB + alignment)
constexpr int MAX_DYNAMIC_SHARED_MEMORY_SIZE =
    228 * 1024 - WORKER_RESERVED_STATIC_SHARED_MEMORY_SIZE;
...
enum TaskType {
  ...
  TASK_MTP_VERIFY_STRICT = 269,
  TASK_MTP_VERIFY_PROBABILISTIC = 270,
  TASK_MTP_VERIFY_SYNTHETIC = 271,
