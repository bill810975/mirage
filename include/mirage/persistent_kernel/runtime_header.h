...
enum TaskType {
  ...
  TASK_MLA_PREFILL_TP8_CHUNKED_SM100 = 279,
  ...
  TASK_MLA_PREFILL_TP8_CHUNKED_SPLITK_SM100 = 298,
  TASK_MLA_PREFILL_TP8_CHUNKED_REDUCE_SM100 = 299,
  TASK_SM100_TASK_END = 300, // SM100 end placeholder, not a real task
  TASK_SCHD_TASKS = 200,
