...
enum TaskType {
  ...
  TASK_PAGED_MLA_SM100 = 266,
  TASK_MTP_VERIFY_STRICT = 267,
  TASK_MTP_VERIFY_PROBABILISTIC = 268,
  TASK_MTP_VERIFY_SYNTHETIC = 269,
  TASK_MTP_ACCEPT_COMMIT = 270,
  TASK_MTP_TOKEN_SCATTER = 271,
  TASK_MTP_PREPARE_VERIFY = 272,
  TASK_TOPK_SIGMOID_SM100 = 273,
  TASK_QUANTIZE_FP8_SM100 = 274,
  TASK_LINEAR_FP8_SM100 = 275,
  TASK_LINEAR_FP8_WITH_RESIDUAL_SM100 = 276,
