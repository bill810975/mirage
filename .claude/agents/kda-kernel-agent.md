...
`/home/muhengl/mirage/tests/runtime_python/blackwell/sm100_fp8_gemm_dense/README_faithful_pertask.md`).
...
- **Validation command** — the faithful test via the bridge (use the FULL venv
  path `/home/muhengl/mirage/.venv/bin/python` — there is no `.venv/python`):
  `MPK_TEST_TIMING_ITERS=40 /home/muhengl/mirage/.venv/bin/python tools/testmode_correctness.py --kernel outputs/kernel.cuh --gpu <g with NO foreign PID> --shape <THIS task's shape> --kind <finen|gemv_m1 matching the candidate namespace> --num-workers 136 [--require-k <K>]`
...
ls /home/muhengl/mirage/tests/runtime_python/blackwell/sm100_fp8_gemm_dense/test_fp8_gemm_dense_finen_pk_testmode.py \
   /home/muhengl/mirage/tests/runtime_python/blackwell/sm100_fp8_gemm_dense/README_faithful_pertask.md
```
...
- Script: `~/kernel_tools/ncu_profile.sh`; engine: `~/kernel_tools/ncu_verdict.py`;
  ...
  `/home/muhengl/mirage/NCU_Usage_Manual.md` §"M=1 decode NCU toolchain".
...
| FAITHFUL per-task harness (the trusted measure) | `/home/muhengl/mirage/tests/runtime_python/blackwell/sm100_fp8_gemm_dense/README_faithful_pertask.md` + `test_fp8_gemm_dense_finen_pk_testmode.py` + `_build_helper.py` |
...
| Repo venv | `/home/muhengl/mirage/.venv/bin/python` |
