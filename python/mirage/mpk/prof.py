...
# ids renumbered in the v2 merge (see runtime_header.h): V2 linear = 242/243
LINEAR_TYPES = {244, 245, 242, 243}
EVENT_NAMES = {
    244: "LINEAR_V3", 245: "LINEAR_RES_V3", 242: "LINEAR_V2",
    243: "LINEAR_RES_V2", 326: "RMSNORM", 327: "SILU_MUL", 328: "EMBEDDING",
    329: "ATTENTION", 330: "ARGMAX_P", 331: "ARGMAX_R",
...
def cmd_summary(d: Dump, iters=WINDOW_ITERS) -> int:
    ...
    b_of = {244: 0, 245: 0, 242: 0, 243: 0, 329: 1, 326: 2, 327: 3,
            330: 4, 331: 4, 328: 5}
    for sm in range(d.nblocks):
